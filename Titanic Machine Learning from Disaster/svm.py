...
train_data = np.delete(train_data,[2,4,7,8,9],1)
...
test_data = np.delete(test_data,[1,3,6,7,8],1) #remove the name data, cabin and ticket
...
open_file_object = csv.writer(open("Data/svm.csv", "wb"))

for prediction in predictions:       
    open_file_object.writerow(prediction)
